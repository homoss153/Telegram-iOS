...
public struct ApplicationSpecificSharedDataKeys {
    ...
    public static let extragrammSettings = applicationSpecificSharedDataKey(ApplicationSpecificSharedDataKeyValues.extragrammSettings.rawValue)
}
