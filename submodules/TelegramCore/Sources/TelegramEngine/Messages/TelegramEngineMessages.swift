...
public extension TelegramEngine {
    final class Messages {
        ...
        public func sendReadForMessage(index: MessageIndex) -> Signal<Void, NoError> {
            return _internal_sendReadForMessage(postbox: self.account.postbox, network: self.account.network, index: index)
        }
